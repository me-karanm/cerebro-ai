      ...
      <main className={`flex-1 flex flex-col h-full min-w-0 transition-all duration-300 ${
        ...
        <div className="w-full h-full overflow-y-auto overflow-x-clip">
          <div className="p-4 lg:p-6 w-full max-w-full">
            {/* Header */}
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-6 w-full max-w-full">
            ...
            {/* Metrics Cards */}
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8 w-full max-w-full">
